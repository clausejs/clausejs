...
var _a = __webpack_require__(11),
    ...
    or = _a.or,
    shape = _a.shape,
    zeroOrOne = _a.zeroOrOne,
    maybe = _a.maybe,
    oneOrMore = _a.oneOrMore,
    fclause = _a.fclause,
    any = _a.any,
    and = _a.and,
    wall = _a.wall,
...
var _b = __webpack_require__(12),
    ...
    isBool = _b.isBool,
    instanceOf = _b.instanceOf;
var _c = __webpack_require__(18),
    conform = _c.conform,
    isClause = _c.isClause,
    deref = _c.deref,
    delayed = _c.delayed;
...
var _d = sExpression_1.genClauses(or('expression', ExprClause, 'altNode', and(instanceOf(AltHeadNode), C.shape({
    required: {
        clause: _isPivot,
    ...
    PartialableSExprClause = _d[0],
    PartialableParamItemClause = _d[1];
var synopsis = fclause({
    ...
    var cSExpr = conform(sExpression_1.ParamItemClause, sExpr);
...
function _strFragments(label, cNode, replacer) {
    ...
    if (head.type === 'FCLAUSE') {
        var _b = params.unlabelled[0].item.unquotedParamsMap,
            _c = _b.args,
            args = (_c === void 0 ? {} : _c).singleParam,
            _d = _b.ret,
            ret = (_d === void 0 ? {} : _d).singleParam;
        ...
        var _e = params.unlabelled[0].item.unquotedParamsMap,
            _f = _e.required,
            required = (_f === void 0 ? { singleParam: {} } : _f).singleParam.quotedParamsMap,
            _g = _e.optional,
            optional = (_g === void 0 ? { singleParam: {} } : _g).singleParam.quotedParamsMap;
        var items = [];
        if (required) {
        ...
        var _h = params.unlabelled[0].item.unquotedParamsMap,
            keyExprAlts = _h.key.singleParam,
            valExprAlts = _h.val.singleParam;
...
function _fold(reducer, _a, init, replacer, inFclause) {
    ...
    if (sExpression) {
        var headAlts = sExpression.head,
            ...
            _c = _b === void 0 ? {} : _b,
            labelled = _c.labelled,
            unlabelled = _c.unlabelled;
        var head_1 = clauseFromAlts(headAlts);
        var replaced;
        if (replacer) {
...
var isPred_1 = __webpack_require__(10);
var isClause_1 = __webpack_require__(5);
var preds_1 = __webpack_require__(12);
var describe_1 = __webpack_require__(30);
var deref_1 = __webpack_require__(29);
var resolve_1 = __webpack_require__(43);
var syntax_1 = __webpack_require__(85);
var clauseFromAlts = __webpack_require__(6);
...
function genForExpression(globalReg, exprName, expr, meta) {
    var docstr;
    var path = resolve_1.resolve(expr, globalReg);
    if (path && !exprName) {
...
function _refExprFn(reg, currPath) {
    return function (expr) {
        var path = resolve_1.resolve(expr, reg);
