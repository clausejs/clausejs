...
module.exports = function (hljs) {
  ...
  return {
    ...
    contains: [{
      ...
      className: 'meta',
      begin: /^#!/, end: /$/
    }, hljs.APOS_STRING_MODE, hljs.QUOTE_STRING_MODE, INTERNAL_KEY, hljs.C_LINE_COMMENT_MODE, hljs.C_BLOCK_COMMENT_MODE, NUMBER, { // object attr container
      begin: /[{,]\s*/, relevance: 0,
      contains: [{
        begin: IDENT_RE + '\\s*:', returnBegin: true,
        relevance: 0,
...
var _tether = __webpack_require__(93);
...
(0, _jquery2.default)(function () {
  ...
  (0, _jquery2.default)('.code-examples pre code').each(function (i, block) {
    HLJS.highlightBlock(block);
  });

  (0, _jquery2.default)('pre.clause-description code').each(function (i, block) {
    HLJS.highlightBlock(block);
  });
