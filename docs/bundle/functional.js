...
Object.defineProperty(exports, "__esModule", { value: true });
function hljsClause(hljs) {
    var IDENT_RE = '[A-Za-z$_][0-9A-Za-z$_]*';
    var KEYWORDS = {
        keyword: 'wall delayed maybe nullable undefinable scat fclause any mapOf collOf shape cat or zeroOrMore oneOrMore zeroOrOne',
...
var tether = __webpack_require__(100);
var src_1 = __webpack_require__(43);
// require( 'bootstrap/dist/css/bootstrap.css' );
__webpack_require__(99);
var HLJS = __webpack_require__(97);
var hljsjs = __webpack_require__(98);
var highlightjs_clause_1 = __webpack_require__(89);
HLJS.registerLanguage('javascript', hljsjs);
HLJS.registerLanguage('clause', highlightjs_clause_1.default);
window.$ = window.jQuery = $;
window.Tether = tether;
window.Util = __webpack_require__(96);
window.Tooltip = __webpack_require__(95);
window.Popover = __webpack_require__(94);
window.CodeMirror = __webpack_require__(93);
__webpack_require__(92);
$(function () {
    //highlight source code
    $('.code-examples pre code').each(function (i, block) {
        HLJS.highlightBlock(block);
    });
    $('pre.clause-description code').each(function (i, block) {
        HLJS.highlightBlock(block);
    });
    ...
    //   } );
    // } );
    $('.launch-code-examples').click(function (e) {
