...
module.exports = function (hljs) {
    var IDENT_RE = '[A-Za-z$_][0-9A-Za-z$_]*';
    var KEYWORDS = {
        keyword: 'wall delayed maybe nullable undefinable cstr fclause any mapOf collOf shape cat or zeroOrMore oneOrMore zeroOrOne',
    ...
    SUBST.contains = [hljs.APOS_STRING_MODE, hljs.QUOTE_STRING_MODE, INTERNAL_KEY, NUMBER, hljs.REGEXP_MODE];
    ...
    return {
        ...
        contains: [{
            ...
            className: 'meta',
            begin: /^#!/, end: /$/
        }, hljs.APOS_STRING_MODE, hljs.QUOTE_STRING_MODE, INTERNAL_KEY, hljs.C_LINE_COMMENT_MODE, hljs.C_BLOCK_COMMENT_MODE, NUMBER, {
            begin: /[{,]\s*/, relevance: 0,
            contains: [{
                begin: IDENT_RE + '\\s*:', returnBegin: true,
                relevance: 0,
...
Object.defineProperty(exports, "__esModule", { value: true });
var jquery_1 = __webpack_require__(84);
var tether_1 = __webpack_require__(93);
var src_1 = __webpack_require__(44);
// require( 'bootstrap/dist/css/bootstrap.css' );
__webpack_require__(101);
var HLJS = __webpack_require__(91);
HLJS.registerLanguage('javascript', __webpack_require__(92));
HLJS.registerLanguage('clause', __webpack_require__(94));
window.$ = window.jQuery = jquery_1.default;
window.Tether = tether_1.default;
window.Util = __webpack_require__(100);
window.Tooltip = __webpack_require__(99);
window.Popover = __webpack_require__(98);
window.CodeMirror = __webpack_require__(97);
__webpack_require__(90);
jquery_1.default(function () {
    //highlight source code
    jquery_1.default('.code-examples pre code').each(function (i, block) {
        HLJS.highlightBlock(block);
    });
    jquery_1.default('pre.clause-description code').each(function (i, block) {
        HLJS.highlightBlock(block);
    });
    ...
    //   } );
    // } );
    jquery_1.default('.launch-code-examples').click(function (e) {
        var name = jquery_1.default(e.target).data('name');
...
window.klipse_settings = {
    selector_es2017: '.noop-doesnt-exist pre code',
...
jquery_1.default(function () {
    window.TodoItemClause = src_1.default.shape({
        required: ['title']
    });
